import { n as createLucideIcon, $ as toDate, a0 as constructFrom, a1 as getDefaultOptions, a2 as getTimezoneOffsetInMilliseconds, a3 as millisecondsInDay, a4 as millisecondsInWeek, a5 as enUS, a6 as constructNow, m as useParams, u as useAuth, c as useNavigate, a as useActor, b as useQueryClient, r as reactExports, d as useQuery, e as useMutation, j as jsxRuntimeExports, B as Button, A as AvatarImage, l as ue, g as createActor } from "./index-Dq5HxgdE.js";
...
function groupMessages(messages, myPrincipal) {
  const groups = [];
...
function ThreadHeaderSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-4 py-3 border-b border-border bg-card flex-shrink-0", children: [
...
function MessagesSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": "chat_thread.loading_state", className: "space-y-4 px-4 py-4", children: [false, true, false, true, true].map((isMine, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
...
function ChatThreadPage() {
  ...
  const { data: messages, isLoading: messagesLoading } = useQuery({
    queryKey: ["conversation", (_a = partnerProfile == null ? void 0 : partnerProfile.principal) == null ? void 0 : _a.toString()],
    queryFn: async () => {
  ...
  const messagesLen = (messages == null ? void 0 : messages.length) ?? 0;
  reactExports.useEffect(() => {
    var _a2;
    if (messagesLen > 0 && messagesLen !== prevMessageCountRef.current) {
      ...
      (_a2 = bottomRef.current) == null ? void 0 : _a2.scrollIntoView({
  ...
  const sendMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({
        queryKey: ["conversation", (_a2 = partnerProfile == null ? void 0 : partnerProfile.principal) == null ? void 0 : _a2.toString()]
      });
      queryClient.invalidateQueries({ queryKey: ["conversations"] });
    ...
    onError: (err) => {
      ...
      if (err.message === "NOT_ALLOWED") {
        ...
        ue.error("Message failed to send. Try again.");
      }
    }
  });
  const handleSend = () => {
  ...
  const messageGroups = messages && principal ? groupMessages(messages, principal) : [];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        profileLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(ThreadHeaderSkeleton, {}) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-4 py-3 border-b border-border bg-card flex-shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              variant: "ghost",
          ...
          partnerProfile ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              className: "flex items-center gap-3 flex-1 min-w-0 hover:opacity-80 transition-opacity",
              onClick: () => navigate({ to: `/profile/${partnerProfile.username}` }),
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  AvatarImage,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 text-left", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground truncate leading-tight", children: partnerProfile.displayName }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              messagesLoading || profileLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(MessagesSkeleton, {}) : !messages || messages.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
                    ...
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: (partnerProfile == null ? void 0 : partnerProfile.displayName) ?? partnerUsername }),
                    "!"
                  ] })
                }
              ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: messageGroups.map((group) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `flex flex-col gap-0.5 ${group.isMine ? "items-end" : "items-start"}`,
                  children: group.messages.map((msg, mi) => {
                      ...
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              className: `max-w-[75%] px-4 py-2.5 text-sm leading-relaxed ${group.isMine ? "bg-primary text-primary-foreground rounded-2xl rounded-br-sm" : "bg-muted text-foreground rounded-2xl rounded-bl-sm"} ${!isLast ? "mb-0.5" : ""}`,
                              children: msg.text
                            }
                          ),
                          isLast && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground mt-1 px-1", children: formatMessageTime(msg.createdAt) })
                        ]
                      },
                      msg.id.toString()
                    );
                ...
                group.messages[0].id.toString()
              )) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: bottomRef })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-2 px-4 py-3 border-t border-border bg-card flex-shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "textarea",
            {
              ref: inputRef,
              ...
              placeholder: `Message ${(partnerProfile == null ? void 0 : partnerProfile.displayName) ?? partnerUsername}…`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: sendMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: "h-4 w-4" })
            }
          )
        ] })
      ]
